...
function ViewPlanForTomorrowForDriver(){
    ...
    useEffect(() => {
        fetch("http://localhost:8081/api/tours/getPlanForTomorrowForDriver/"+username, {
            headers : {
    ...
    return(
        <body>
            <div class="topnav">
                <a href="/DriverHomePage">Plan For Today</a>
                <a className='active' href="/DriverTomorrowPlan">Plan For Tomorrow</a>
                <a href="/">Logout</a>
            </div>
...
export default ViewPlanForTomorrowForDriver;